<header class="sticky top-0 flex w-full bg-white z-999 drop-shadow-1 dark:bg-boxdark dark:drop-shadow-none">
    <div class="flex items-center justify-between flex-grow px-4 py-4 shadow-2 md:px-6 2xl:px-11">
        ...
        <div class="flex items-center justify-end w-full gap-3 2xsm:gap-7">
            <ul class="flex items-center gap-2 2xsm:gap-4">
                ...
                <li class="relative" x-data="{ dropdownOpen: false, notifying: true }" @click.outside="dropdownOpen = false">
                    <a class="relative flex h-8.5 w-8.5 items-center justify-center rounded-full border-[0.5px] border-stroke bg-gray text-primary dark:border-strokedark dark:bg-meta-4 dark:text-white"
